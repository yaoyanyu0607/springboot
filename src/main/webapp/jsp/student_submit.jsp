                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tr style="text-align: center">
                                        ...
                                        <td>
                                            <a type="submit" class="btn btn-primary btn-xs" href="edit_homework?homework_title=<%=homework.getHomework_title()%>&teacher_name=<%=homework.getTeacher_name()%>">上传作业</a>
                                        </td>
                                    </tr>
                                    <%
                                            i++;
